...
Микросервис для генерации текстовых превью файлов, которые браузер не умеет отображать нативно (DOCX, XLSX). Изображения и PDF рендерятся браузером напрямую через file-service.
